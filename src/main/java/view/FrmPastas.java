...
public class FrmPastas extends javax.swing.JFrame {
...
//atualiza tabela
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        ...
        try {
            model = controle.tabelaPastas();
        } catch (SQLException ex) {
            Logger.getLogger(FrmPastas.class.getName()).log(Level.SEVERE, null, ex);
        }
        jTableCards.setModel(model);
    }//GEN-LAST:event_formWindowActivated

    private void btnExportarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExportarActionPerformed
        exportarTabelaParaExcel(); //exporta arquivo
